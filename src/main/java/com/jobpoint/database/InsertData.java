...
public class InsertData {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		connection.createStatement().execute("insert into trading (product_id, enter_price, exit_price, profit, enter_date, enter_time, exit_date, exit_time, situation) values " +
				...
				"(901, '2.919', '2.870', '0.049', '06/10/2017', '02:33', '09/10/2017',  '14:03', false) ");
